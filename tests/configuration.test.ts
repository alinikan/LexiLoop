...
const valid = {
  ...
  RESEND_API_KEY: 'private-fixture',
  SIGNUP_NOTIFICATION_TO: 'owner@example.com',
  SIGNUP_NOTIFICATION_FROM: 'LexiLoop <notifications@example.com>',
  SIGNUP_WEBHOOK_SECRET: 'fixture-secret-with-at-least-32-characters',
  AI_PROVIDER: 'openai',
  MOCK_AI: 'false',
